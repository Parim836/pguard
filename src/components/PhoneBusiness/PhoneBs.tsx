...
import "./style-phone-business.css";
                                ...
                                <div className="business-service-screen">
                                    ...
                                    <main className="business-service-main">
                                        ...
                                        <div className="business-service-list">
                                            {[
                                                [t("รปภ.มืออาชีพ"), "", t("฿1 / ชม."), t("ขั้นต่ำ 1 ชม.")],
                                                [t("รปภ.ฝึกหัด"), t("ทดสอบ & ฝึก"), t("฿1 / ชม."), t("ขั้นต่ำ 12 ชม.")],
                                                [t("บอดี้การ์ด"), t("เหมาะกับงานหมู่บ้าน"), t("฿60 / ชม."), t("ขั้นต่ำ 12 ชม.")],
                                            ].map(([title, detail, price, minimum]) => (
                                                <article className="business-service-card" key={title}>
                                                    <span className="business-service-icon"><Shield /></span>
                                                    <div>
                                                        <strong>{title}</strong>
                                    ...
                                    <nav className="business-service-bottom-nav" aria-label={t("เมนูหลัก")}>
                                        <span className="active"><Shield /><small>{t("หน้าหลัก")}</small></span>
                                        <span><CalendarDays /><small>{t("การจอง")}</small></span>
                                        <span className="business-service-action"><Shield /></span>
                                        <span><WalletCards /><small>{t("กระเป๋า")}</small></span>
                                        <span><UserRound /><small>{t("โปรไฟล์")}</small></span>
                                    </nav>
                                </div>
                            </div>
                        </div>
