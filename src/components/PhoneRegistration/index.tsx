    ...
    <div className="smart-search-phone">
      <PhoneFrame>
        <div className="registration-app-screen">
          ...
          <div className="registration-app-progress" aria-hidden="true">
            <span />
            <span />
            <span />
            <span />
          </div>
          <small className="registration-app-step">
            {t("ขั้นที่ 2 จาก 4")}
          </small>
            ...
            {documents.map((document) => (
              <div className="registration-document-row" key={document}>
                ...
                <div>
                  ...
                  <small>{t("ยังไม่อัปโหลด")}</small>
                </div>
                <span className="registration-upload-label">
                  {t("อัปโหลด")}
                </span>
              </div>
            ))}
